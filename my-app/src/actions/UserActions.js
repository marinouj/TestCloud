...
export const loadUsers = async () => {
  const newData = await fetch("http://34.64.81.28:8080/loadUsers", {
    method: "GET",
    headers: {
...
export const verifyUser = async (user) => {
  console.log(user);
  const newData = await fetch("http://34.64.81.28:8080/login", {
    method: "POST",
...
export const getUser = async (id) => {
  const newData = await fetch("http://34.64.81.28:8080/getUser", {
    method: "POST",
...
export const createUser = async (user) => {
  await fetch("http://34.64.81.28:8080/createUser", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
...
export const confirmUser = async (id) => {
  const newData = await fetch("http://34.64.81.28:8080/confirmUser", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
...
export const updateUser = async (user) => {
  const newData = await fetch("http://34.64.81.28:8080/updateUser", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
...
export const deleteUser = async (id) => {
  const newData = await fetch("http://34.64.81.28:8080/deleteUser", {
    method: "POST",
    body: JSON.stringify({ id: id }),
    headers: {
      "Content-Type": "application/json",
